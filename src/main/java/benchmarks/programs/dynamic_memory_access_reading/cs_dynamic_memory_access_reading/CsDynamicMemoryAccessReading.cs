...
namespace Benchmarks
{
    ...
    class CsDynamicMemoryAccessWriting
    {
        ...
        static void InitializeArray(Point[] arr, int size)
        {
        ...
        static void ReadFromArray(Point[] arr, int size)
               {
                   for (int i = 0; i < size; i++)
                   {
                       if(arr[i].X == 2) continue;
                   }
               }
        ...
        static double MeasureAllocationTime(int arraySize, long frequency)
        {
            ...
            ReadFromArray(dynamicArray, arraySize);
        ...
        static void Main(string[] args)
        {
            ...
            string filePath = "../../../../../../result_files/dynamic_memory_access_reading/cs_dynamic_memory_access_reading_result.txt";
